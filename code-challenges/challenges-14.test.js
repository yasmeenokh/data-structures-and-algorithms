...
let biggerThanLuke = (arr) => {
  // Solution code here...
  let newArr= arr.filter(element=> Number(element.mass)>77).map(element=>element.name).join(' - ');
...
const detectTicTacToeWin = (board) => {
  ...
  //   if (board[row1][col1]=== board[row2][col2] && board[row1][col1]=== board[row3][col3] && board[row2][col2]=== board[row3][col3] && board[row1][col1] !== '' )
  //   {
  //     answer = true;
  //   }
  // };
  // return answer;
  // let helpCheck = (arr1, arr2, arr3)=>{
  //   let checkArray = !(arr1 === '' && arr2 === '' && arr3 === '') && (arr1 === arr2 && arr1 === arr3);
  //   return checkArray;
  // };
  ...
  //     return true;
  //   }
  //   if (helpCheck(board[0][i], board[1][i], board[2][i])) {
  //     return true;
  //   }
  // }
  for (let i = 0; i < board.length; i++) {
