...
const validateWord = (word) => {
  // Solution code here...
  let regex = /^[a-zA-Z]{5,10}$/g.test(word);
  return regex;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const hasNumber = (string) => {
  // Solution code here...
  let regex = /^[a-zA-Z]+[0-9]/.test(string);
  return regex;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 5
...
const validateEmail = (email) => {
  // Solution code here...
  // let regex = /^\w+([.-]?\w+)*@\w+([.-]?\w+)*(\.\w{2,3})+$/g.test(email);
  let regex =   /^[a-z0-9]+(.[a-z0-9]+)?@[a-z]+.(net|com|org)$/g.test(email);
  return regex;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 6
